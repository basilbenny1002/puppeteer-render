...
const scrapeLogic = async (res) => {
  try {
    ...
    const cookies = [
      {
        name: "unique_id",
        value: "Wg7eCDAjuzAW0IDGTqRk6tt8I1QP3Awe",
        domain: ".twitch.tv",
      },
      ...
      {
        name: "last_login",
        value: "2025-06-27T16:51:49Z",
        domain: ".twitch.tv",
      },
      {
        name: "api_token",
        value: "9311df6c6d6af5b9904a15c78330f656",
        domain: ".twitch.tv",
      },
      {
        name: "twilight-user",
        value:
          '{"authToken":"0bnm6vsthetgctlnksj8hs2g2zxplt","displayName":"apple_juice_is_fine","id":"1326785290","login":"apple_juice_is_fine","roles":{"isStaff":false},"version":2}',
        domain: ".twitch.tv",
      },
      {
        name: "auth-token",
        value: "0bnm6vsthetgctlnksj8hs2g2zxplt",
        domain: ".twitch.tv",
      },
      {
        name: "server_session_id",
        value: "3d9dfee2eead45fdafc4114e5d1c3114",
        domain: ".twitch.tv",
      },
    ];
    ...
    await context.setCookie(...validCookies);
